...
trait GeneratesPdfTrait
{
    ...
    public function getFieldsArray()
    {
        ...
        $fields = [
            ...
            '{COMPANY_FAX}' => $companyAddress->fax,
            '{COMPANY_EMAIL}' => $companyAddress->email,
            '{COMPANY_WEBSITE}' => $companyAddress->website,
            '{COMPANY_VAT}' => $this->company->vat_id,
            '{COMPANY_TAX}' => $this->company->tax_id,
            '{COMPANY_PATENTE}' => $this->company->patente,
            '{COMPANY_CNSS}' => $this->company->cnss,
            '{COMPANY_RC}' => $this->company->rc,
            '{COMPANY_ICE}' => $this->company->ice,
