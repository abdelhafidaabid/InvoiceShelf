    ...
    public function getInvoicePayload(): array
    {
        ...
        return collect($this->except('items', 'taxes'))
            ->merge([
                ...
                'show_signature' => $this->has('show_signature') ? $this->show_signature : (CompanySetting::getSetting('invoice_show_signature', $this->header('company')) !== 'NO'),
                'show_page_number' => $this->has('show_page_number') ? $this->show_page_number : (CompanySetting::getSetting('invoice_show_page_number', $this->header('company')) !== 'NO'),
            ])
            ->toArray();
    }
}
