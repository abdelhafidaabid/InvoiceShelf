...
<head>
    ...
    @php
        ...
        // Simple Amount to Words conversion for French
        ...
        $totalInWords = amountToWords($invoice->total);
    @endphp
    <style type="text/css">
        /* -- Base & Fonts -- */
        body {
...
<body>
            ...
            <tr>
                <td width="60%" style="vertical-align: top; padding-top: 20px;">
                    <div class="header-title-text">
                        @lang('pdf_invoice_label')<span class="header-year">{{ date('Y') }}</span>
                    </div>
    ...
    <div class="content-wrapper">
        <div class="client-section">
            <div class="client-label">@lang('pdf_bill_to')</div>
        ...
        <div class="amount-in-words-section">
            ...
            <span class="amount-words">{{ $totalInWords }} {{ $invoice->customer->currency->code }}</span>
        </div>
    ...
    @if ($invoice->company)
        <div class="footer-company-info">
            <div class="footer-company-name">{{ $invoice->company->name }}</div>
            {!! $company_address !!}
        </div>
    @endif
