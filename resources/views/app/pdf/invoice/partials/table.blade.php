<table width="100%" class="items-table" cellspacing="0" border="0">
    <tr class="item-table-heading-row">
        ...
        <th width="40%" class="pl-0 text-left item-table-heading">{{ $invoice->getPdfLabel('invoice_pdf_items_label', 'pdf_items_label') }}</th>
            ...
            <td width="40%" style="vertical-align: top;">
                <table width="100%" cellspacing="0px" border="0" class="total-display-table @if(count($invoice->items) > 12) page-break @endif" style="width: 100% !important;">
                    ...
                    <tr>
                        ...
                        <td
                            class="py-8 border-0 total-border-right total-table-attribute-value"
                            style="color: #5851D8"
                        >
